from squishy_coordinator import logger
from squishy_coordinator.rest_client import RestClient
...
class CoordinatorFactory:
    ...
    def create_service() -> CoordinatorService:
        ...
        # Create implementations
        rest_service = (RestClient()).rest_client
        storage = PersistentStorage(rest_service)

        logger.info("Application configured services with default configuration")

        # Create main service
        return CoordinatorService(storage)